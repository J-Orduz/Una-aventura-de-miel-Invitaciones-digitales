  ...
  return (
    <div className="relative h-full w-full overflow-hidden select-none">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, #3f8fc4 0%, #7fc3ea 22%, #a9d8f2 40%, #6bb4e0 58%, #7fc3ea 78%, #3686b8 100%)',
        }}
      >
        {/* Pliegues verticales */}
        <div
          ...
          style={{
            background:
              'repeating-linear-gradient(90deg, rgba(30, 90, 130, 0.28) 0 8px, rgba(220, 240, 252, 0.18) 8px 22px, rgba(28, 74, 110, 0.22) 22px 46px)',
          }}
        />
        {/* Resplandor central */}
        <div
          ...
          style={{
            background:
              'linear-gradient(100deg, transparent 30%, rgba(255,255,255,0.18) 48%, transparent 62%)',
          }}
        />
      </div>
